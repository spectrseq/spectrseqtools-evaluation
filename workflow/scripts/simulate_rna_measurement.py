...
breakage_line = snakemake.config["fragmentation_parameters"][2]["breakage_line"]
fragmentation_process = snakemake.config["fragmentation_parameters"][3][
    "fragmentation_process"
]
noise_distribution = snakemake.config["fragmentation_parameters"][4][
    "noise_distribution"
]
...
def add_backbone_masses(
    fragment, backbone_masses, fragment_masses, breakage_line="c-y"
):
    if breakage_line == "c-y":
